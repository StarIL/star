(function ($) {
    ...
    DApiUI.createDetailMenu=function (menu) {
        ...
        //简介li
        var dli=$('<li  class="active detailMenu"><a href="javascript:;"><i class="icon-text-width"></i><span class="menu-text"> 简介 </span></a></li>')
        ...
        $.each(menu.tags,function (i, tag) {
            ...
            if(len==0){
                var li=$('<li class="detailMenu"><a href="javascript:;"><i class="icon-text-width"></i><span class="menu-text"> '+tagInfo.name+' </span></a></li>');
                DApiUI.getMenu().append(li);
            }else{
                //存在子标签
                var li=$('<li  class="detailMenu"></li>');
                var titleA=$('<a href="javascript:;" class="dropdown-toggle"><i class="icon-file-alt"></i><span class="menu-text">'+tagInfo.name+'<span class="badge badge-primary ">'+len+'</span></span><b class="arrow icon-angle-down"></b></a>');
                li.append(titleA);
                //循环树
