...
<html>
	<head>
        ...
        #modifyiphoneFirst{background: #ffff;}
        #modifyiphone{background: #ffff;}
	...
	<body class="mui-fullscreen contenet"> 
		<div id="wapper" class="mui-page-content">
        	...
        	<div id="modifyiphoneFirst" class="mui-page">
        	...
        	<div id="modifyiphone" class="mui-page">
	            <div class="mui-content-padded">
	                <div class="mui-input-row"><input type="text" class="mui-icon-mobile  mui-input-clear" placeholder="请输入新手机号" /></div>
	                <div class="mui-input-row">
	                    <input type="text" class="mui-icon-code" placeholder="请输入验证码" maxlength="6" />
	                    <button class="mui-btn mui-btn-primary mui-btn-code" style="padding: 3px;" disabled="disabled">发送验证码</button>
	                </div>
	                <button data-loading-text="提交中" style="font-size: 15px;"  class="mui-btn mui-btn-block mui-btn-primary" v-on:tap="next()">保存</button>
	            </div>
        	</div>
		</div>
	</body>
...
<script src="${pageContext.request.contextPath}/js/myAccount/modifyPhone.js"></script>
</html>
